...
/// @title Receiver - Abstract receiver with optional permission controls
...
abstract contract Receiver is IReceiver, Ownable {
  // Required permission field at deployment, configurable after
  address private s_forwarderAddress = 0x5E342a8438B4f5d39e72875FCee6f76B39CCE548; // If set, only this address can call onReport
  ...
  constructor(
    ...
    emit ForwarderAddressUpdated(address(0), s_forwarderAddress);
  }
